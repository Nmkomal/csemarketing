    ...
    <div className="bg-white pt-28 pb-16">
      <section className="container mx-auto px-6 mb-16">
        <div className="max-w-4xl">
          <h4 className="text-yellow-600 font-black uppercase tracking-[0.3em] text-sm mb-4">FAQ</h4>
      ...
      <section className="container mx-auto px-6 mb-16 grid lg:grid-cols-12 gap-12">
        {/* Accordion List */}
          ...
          {FAQS.map((faq, idx) => (
            <div 
              ...
              className={`border rounded-[30px] overflow-hidden transition-all duration-300 ${
                openIndex === idx ? 'border-yellow-400 bg-gray-50 shadow-sm' : 'border-gray-100 hover:border-gray-200'
              }`}
            >
              <button 
              ...
              >
                <span className="text-lg md:text-xl font-black pr-6">{faq.question}</span>
              ...
              <div 
                className={`px-6 md:px-8 pb-8 transition-all duration-300 ${
        ...
        <div className="lg:col-span-4">
          <div className="sticky top-28 bg-black text-white p-8 rounded-[40px] overflow-hidden text-center">
             ...
             <Button variant="primary" className="w-full py-3.5 rounded-xl mb-4 text-sm" onClick={() => window.location.hash = 'contact'}>Chat with Us</Button>
             <p className="text-[10px] font-bold uppercase tracking-widest text-gray-500">Typical response time: 2 hours</p>
          </div>
        </div>
      </section>
      ...
      <section className="container mx-auto px-6">
        <div className="grid md:grid-cols-3 gap-6">
            {[
                ...
                <div key={i} className="bg-gray-50 p-8 rounded-[30px] border border-gray-100 hover:border-yellow-400 transition-all group cursor-pointer">
                  <div className="w-10 h-10 bg-white rounded-xl flex items-center justify-center mb-4 group-hover:bg-yellow-400 transition-colors">
                  ...
                  <span className="text-[10px] font-black uppercase tracking-widest text-black group-hover:text-yellow-600 flex items-center">
