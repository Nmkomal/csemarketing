...
export const AboutUsPage: React.FC = () => {
  return (
    <div className="bg-white min-h-screen w-full overflow-hidden relative">
      ...
      {/* 1. Premium Banner Section - Static, Fast Load */}
      <section className="relative pt-32 pb-24 bg-white text-black rounded-b-[40px] md:rounded-b-[60px] overflow-hidden border-b border-gray-100 z-20">
        {/* Background Decor - Optimized */}
        <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-yellow-400/10 rounded-full blur-[100px] pointer-events-none -translate-y-1/2 translate-x-1/2"></div>
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          <div className="inline-flex items-center px-4 py-2 rounded-full bg-yellow-50 border border-yellow-200 text-yellow-700 text-xs font-bold uppercase tracking-[0.2em] mb-8 shadow-sm">
            <Award className="w-4 h-4 mr-2" />
            Excellence Since 2019
          </div>
          
          <h1 className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-heading font-black mb-8 leading-[1.1] tracking-tight text-black">
            Architects of <br />
          ...
          <p className="text-lg md:text-2xl text-gray-500 max-w-3xl mx-auto font-medium leading-relaxed mb-10">
      ...
      <section className="container mx-auto px-6 mb-24 mt-24">
        <div className="grid md:grid-cols-2 gap-8 md:gap-12">
          <div className="bg-black text-white p-8 md:p-16 rounded-[3rem] relative overflow-hidden group">
            <div className="absolute top-0 right-0 w-64 h-64 bg-yellow-400/20 rounded-full blur-3xl -mr-32 -mt-32"></div>
            <Target className="w-12 h-12 md:w-16 md:h-16 text-yellow-400 mb-6 md:mb-8" />
            <h3 className="text-3xl md:text-4xl font-black mb-6">Our Mission</h3>
          ...
          <div className="bg-yellow-400 p-8 md:p-16 rounded-[3rem] relative overflow-hidden group shadow-xl shadow-yellow-400/20 text-black">
            <Eye className="w-12 h-12 md:w-16 md:h-16 text-black mb-6 md:mb-8" />
            <h3 className="text-3xl md:text-4xl font-black mb-6 text-black">Our Vision</h3>
            <p className="text-lg md:text-xl text-black/80 leading-relaxed font-bold">
      ...
      {/* 5. Team Section (Moved Up & Centered) */}
      <section className="py-24 bg-gray-50 border-y border-gray-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {TEAM.map((member, i) => (
              <div key={i} className="group relative">
                <div className="relative aspect-[3/4] rounded-[2.5rem] overflow-hidden mb-6 bg-white border border-gray-100 shadow-sm">
                  <img 
                    src={member.image} 
                    alt={member.name} 
                    loading="lazy"
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
            {[
              ...
              <div key={i} className="text-center p-8 rounded-[2rem] bg-gray-50 border border-gray-100 hover:border-yellow-400 hover:shadow-xl transition-all duration-300 group">
                <div className="w-16 h-16 bg-white rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:bg-yellow-400 transition-colors">
