...
import { History, Target, Eye, Shield, Users, Star, Heart, Award, ArrowRight } from 'lucide-react';
    ...
    <div className="bg-white min-h-screen">
       ...
       <section className="py-24 bg-white">
        <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="order-1 lg:order-2 relative">
            <div className="relative z-10 rounded-[2rem] md:rounded-[3rem] overflow-hidden shadow-2xl border-4 border-white">
              <img 
      ...
      <section className="container mx-auto px-6 mb-24">
        <div className="grid md:grid-cols-2 gap-8 md:gap-12">
          <div className="bg-black text-white p-8 md:p-16 rounded-[3rem] relative overflow-hidden group hover:-translate-y-2 transition-transform duration-500">
          ...
          <div className="bg-yellow-400 p-8 md:p-16 rounded-[3rem] relative overflow-hidden group hover:-translate-y-2 transition-transform duration-500 shadow-xl shadow-yellow-400/20">
      ...
      <section className="py-24 bg-gray-50 border-y border-gray-100">
        <div className="container mx-auto px-6">
          <div className="text-center mb-20">
            ...
            <h2 className="text-4xl md:text-5xl font-heading font-black mb-4">Core Values</h2>
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
            <div className="max-w-2xl">
              ...
              <h2 className="text-4xl md:text-5xl font-heading font-black">Meet the Experts</h2>
            </div>
          </div>
