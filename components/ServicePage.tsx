...
export const ServicePage: React.FC<ServicePageProps> = ({ serviceId, onBack }) => {
  ...
  return (
    <div className="bg-white min-h-screen pb-12">
      ...
      <section className="relative pt-24 pb-12 lg:pt-28 lg:pb-16 overflow-hidden bg-gray-50 rounded-b-[40px] md:rounded-b-[60px] border-b border-gray-100">
        ...
        <div className="container mx-auto px-6 relative z-10">
            ...
            <button 
                onClick={onBack}
                className="group flex items-center text-xs font-black uppercase tracking-widest text-gray-400 hover:text-black transition-colors mb-8"
            >
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
                {/* Left Content */}
                <div>
                    <span className="inline-block py-2 px-5 rounded-full bg-white border border-gray-200 text-yellow-600 text-[10px] font-black uppercase tracking-[0.2em] mb-4 shadow-sm">
                        Service Spotlight
                    </span>
                    <h1 className="text-4xl sm:text-5xl md:text-6xl font-heading font-black mb-4 leading-[1.1] text-black">
                        {data.title}
                    </h1>
                    <p className="text-lg md:text-xl text-gray-500 leading-relaxed mb-8 font-medium max-w-xl">
                        {data.overview}
                    </p>
                    <div className="flex flex-wrap gap-4">
                        <Button 
                            variant="primary" 
                            size="lg" 
                            className="h-14 px-8 rounded-2xl shadow-xl shadow-yellow-400/20 hover:scale-105 text-base"
                    ...
                    <div className="mt-6 flex items-center space-x-2 text-xs font-bold text-gray-400 uppercase tracking-wider">
                        <div className="flex">
        ...
        <div className="container mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="text-4xl font-heading font-black mb-6 text-black">Common Problems We Solve</h2>
              <div className="space-y-4">
                {data.problems.map((problem: string, i: number) => (
                  <div key={i} className="flex items-start p-5 bg-gray-50 rounded-2xl border border-gray-100 shadow-sm group hover:bg-white hover:border-yellow-400 hover:shadow-lg transition-all duration-300">
      ...
      <section className="py-16 bg-gray-50 border-y border-gray-100">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <div className="flex flex-wrap justify-center gap-4 mt-6">
              {data.tools.map((tool: string, i: number) => (
                <div key={i} className="px-6 py-3 bg-white border border-gray-200 rounded-xl shadow-sm text-base font-bold hover:shadow-md hover:border-yellow-400 hover:text-yellow-600 transition-all cursor-default">
                  {tool}
                </div>
              ))}
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 mt-12">
            <div className="p-10 rounded-[30px] bg-yellow-400 border border-yellow-500 relative overflow-hidden group">
            ...
            <div className="p-10 rounded-[30px] bg-white border border-gray-200 shadow-xl flex flex-col justify-center">
              <h3 className="text-2xl font-black mb-6 text-black">Why This Matters</h3>
      ...
      <section className="py-16 px-6">
        <div className="container mx-auto max-w-5xl bg-black rounded-[40px] p-10 md:p-16 text-center text-white relative overflow-hidden">
           {/* Glow */}
           ...
           <div className="relative z-10">
            <h2 className="text-3xl md:text-4xl font-black mb-6">Ready to start with {data.title}?</h2>
            ...
            <Button 
                variant="primary" 
                size="lg" 
                className="h-14 px-10 rounded-xl text-lg font-bold shadow-xl shadow-yellow-400/20 hover:scale-105"
                onClick={() => window.location.hash = 'contact'}
            >
