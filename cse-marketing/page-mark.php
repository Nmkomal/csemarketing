...
<div class="bg-white min-h-screen w-full overflow-x-hidden">
    ...
    <section class="relative pt-32 pb-20 bg-white text-black overflow-hidden z-20">
        <!-- Background Decor -->
        ...
        <div class="container mx-auto px-6 relative z-10 text-center">
          <div class="inline-flex items-center px-4 py-2 rounded-full bg-yellow-50 border border-yellow-200 text-yellow-700 text-xs font-bold uppercase tracking-[0.2em] mb-8 shadow-sm animate-fade-up">
            <i data-lucide="award" class="w-4 h-4 mr-2"></i>
            Excellence Since 2019
          </div>
          
          <h1 class="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-heading font-black mb-8 leading-[1.1] tracking-tight text-black animate-fade-up-delay-1">
            Architects of <br />
          ...
          <p class="text-lg md:text-2xl text-gray-500 max-w-3xl mx-auto font-medium leading-relaxed mb-10 animate-fade-up-delay-2">
          ...
          <div class="flex justify-center animate-fade-up-delay-2">
            <a href="<?php echo home_url('/contact'); ?>" class="inline-flex items-center justify-center h-16 px-12 rounded-2xl text-lg font-bold bg-yellow-400 text-black shadow-xl shadow-yellow-400/20 hover:shadow-yellow-400/30 hover:scale-105 transform transition-all duration-300">
    ...
    <!-- About Classify Skill Education (Agency Stats) -->
    ...
    <section class="py-24 bg-white overflow-hidden">
        <div class="container mx-auto px-6 grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div class="order-1 lg:order-2 relative">
            <div class="relative z-10 rounded-[2rem] md:rounded-[3rem] overflow-hidden shadow-2xl border-4 border-white max-w-full">
              <img 
    ...
    <section class="container mx-auto px-6 mb-24 mt-20">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
          <div class="bg-black text-white p-8 md:p-12 rounded-[2.5rem] relative overflow-hidden group hover:-translate-y-2 transition-transform duration-500 shadow-xl">
            <div class="absolute top-0 right-0 w-64 h-64 bg-yellow-400/20 rounded-full blur-3xl -mr-32 -mt-32 pointer-events-none"></div>
            <i data-lucide="target" class="w-12 h-12 md:w-14 md:h-14 text-yellow-400 mb-6"></i>
            <h3 class="text-2xl md:text-4xl font-heading font-black mb-4">Our Mission</h3>
            <p class="text-base md:text-lg text-gray-400 leading-relaxed font-medium">
          ...
          <div class="bg-yellow-400 p-8 md:p-12 rounded-[2.5rem] relative overflow-hidden group hover:-translate-y-2 transition-transform duration-500 shadow-xl shadow-yellow-400/20 text-black">
            <i data-lucide="eye" class="w-12 h-12 md:w-14 md:h-14 text-black mb-6"></i>
            <h3 class="text-2xl md:text-4xl font-heading font-black mb-4">Our Vision</h3>
            <p class="text-base md:text-lg text-black/80 leading-relaxed font-bold">
        ...
        <div class="container mx-auto px-6">
          <div class="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
            <div class="max-w-2xl">
              ...
              <h2 class="text-4xl md:text-5xl font-heading font-black text-black">Meet the Experts</h2>
            </div>
          </div>
