...
<div class="bg-white min-h-screen w-full overflow-x-hidden">
    ...
    <!-- 4. Mission & Vision -->
    <section class="container mx-auto px-6 mb-24 mt-24">
        <div class="grid md:grid-cols-2 gap-8 md:gap-12">
          ...
          <div class="bg-yellow-400 p-8 md:p-16 rounded-[3rem] relative overflow-hidden group hover:-translate-y-2 transition-transform duration-500 shadow-xl shadow-yellow-400/20 text-black">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            foreach($team as $member): ?>
              <div class="group relative">
                <div class="relative aspect-[3/4] rounded-[2.5rem] overflow-hidden mb-6 bg-white border border-gray-100 shadow-sm">
                  <img 
    ...
    <section class="py-24 bg-white">
        <div class="container mx-auto px-6">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
            ...
            foreach($values as $v): ?>
              <div class="text-center p-8 rounded-[2rem] bg-gray-50 border border-gray-100 hover:border-yellow-400 hover:shadow-xl transition-all duration-300 group">
                <div class="w-16 h-16 bg-white rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:bg-yellow-400 transition-colors">
