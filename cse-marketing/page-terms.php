...
<div class="bg-white min-h-screen pt-32 pb-24">
    ...
    <section class="container mx-auto px-6 mb-16 text-center">
        <h4 class="text-yellow-600 font-black uppercase tracking-[0.3em] text-sm mb-4">Legal</h4>
        <h1 class="text-4xl md:text-6xl font-heading font-black mb-6 leading-[1.1] text-black">
          Terms & <span class="text-yellow-500">Conditions</span>
        </h1>
    ...
    <section class="container mx-auto px-6 max-w-4xl">
        <div class="prose prose-lg max-w-none text-gray-600 prose-headings:font-heading prose-headings:font-black prose-headings:text-black prose-a:text-yellow-600 prose-strong:text-black prose-li:marker:text-yellow-500">
